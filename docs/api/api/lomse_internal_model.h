...
// enums for common values
    ...
    */
    ...
    /**
        ...
        This enum describes valid note types.
    ...
    */
    ...
    /**
        ...
        This enum describes note durations (in Lomse Time Units). It is useful
        for comparisons.
    ...
    */
    enum EArticulations
    {
        ...
        k_articulation_scoop,               ///< Scoop
        k_articulation_plop,                ///< Plop
        k_articulation_doit,                ///< Doit
        k_articulation_falloff,             ///< Fall off
