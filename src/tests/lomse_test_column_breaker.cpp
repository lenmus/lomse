...
//
//        CHECK( soCursor.imo_object()->get_id() == 10 );
...
//        find_next_break(breaker, soCursor);
//
//        CHECK( soCursor.imo_object()->get_id() == 13 );
//        CHECK( is_equal_time(soCursor.time(), 64.0f) );
//    }
//
...
//        find_next_break(breaker, soCursor);
//
//        CHECK( soCursor.imo_object()->get_id() == 12 );
...
//        find_next_break(breaker, soCursor);
//
//        CHECK( soCursor.imo_object()->get_id() == 14 );
//        CHECK( is_equal_time(soCursor.time(), 64.0f) );
//    }
//
...
//        find_next_break(breaker, soCursor);
//
//        CHECK( soCursor.imo_object()->get_id() == 15 );
//        CHECK( is_equal_time(soCursor.time(), 64.0f) );
//    }
//
...
//        find_next_break(breaker, soCursor);
//
//        //cout << "break at id = " << soCursor.imo_object()->get_id() << endl;
//        CHECK( soCursor.imo_object()->get_id() == 14 );
//        CHECK( is_equal_time(soCursor.time(), 64.0f) );
//    }
//
...
//        CHECK( soCursor.imo_object()->get_id() == 19 );
...
//        CHECK( soCursor.imo_object()->get_id() == 22 );
...
//        CHECK( soCursor.imo_object()->get_id() == 25 );
...
//        CHECK( soCursor.imo_object()->get_id() == 29 );
...
//        CHECK( soCursor.imo_object()->get_id() == 31 );
...
//        //cout << "break at id = " << soCursor.imo_object()->get_id() << endl;
//        CHECK( soCursor.imo_object()->get_id() == 33 );
